...
namespace TechExpress.Application.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        /// Public — không cần đăng nhập. Hỗ trợ phân trang, lọc theo rating/hasMedia, sắp xếp theo CreatedAt hoặc Rating.
        /// </summary>
        ...
        /// Guest chưa đăng nhập: Phone và FullName bắt buộc phải truyền.
        /// Comment và Rating luôn bắt buộc. Phone phải là chữ số, 9–12 ký tự.
        /// </summary>
        ...
        /// <summary>
        /// Xóa mềm đánh giá của chính mình. Chỉ dành cho Customer đã đăng nhập và là chủ review đó.
        /// </summary>
